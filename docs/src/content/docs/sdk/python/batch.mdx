...
- [`demos/chain_revision_demo.ipynb`](https://github.com/glacisai/glacis-python/blob/main/demos/chain_revision_demo.ipynb) -- step-by-step notebook building a 3-step chain with revisions
