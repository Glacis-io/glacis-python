...
- [Sampling & Evidence](/reference/sampling-and-evidence/) -- how L2 sampling identifies attestations eligible for judge evaluation
- [Configuration](/connect/configuration/) -- full `glacis.yaml` reference with judges section
